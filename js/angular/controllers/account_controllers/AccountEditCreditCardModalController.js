angular.module('app.controllers.account').controller('AccountEditCreditCardModalController', function ($document, HashKeyCopier, $modalInstance, $q, $scope, $location, $log, CreditCards, JOIN_BASE_URL) {
    alert('app.controllers.account: app.controllers.account');
    
    $log.debug("EditCreditCardModalController(): editing creditCard", CreditCards);

    $scope.creditCard = angular.copy(CreditCards);
