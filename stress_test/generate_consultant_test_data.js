...
for (var i=1; i <= 200; i++) {
    ...
    var consultant = {
        ...
        "email":"Pedro_Villalpando@jafra.com",
        "firstName": "DAVID",
        "lastName":"CASTRO",
        ...
        "billingAddress": {
            ...
            "geocode":"050650770",
            "phone":"123-216-4344",
            "businessCO":"c/o Jafra 3"
        },
        "shippingAddress":{
            "name":"DAVID CASTRO",
            "address1":"C/O JAFRA 3",
            "address2":"7661 INDIAN CANYON CIR",
            "city":"EASTVALE",
            "county":"RIVERSIDE",
            "state":"CA",
            "stateDescription":"CA",
        ...
        "total":23.82,
        "products":[{
            "sku":"19634","qty":1,"kitSelections":{},"components":[{"sku":"124","qty":1},{"sku":"2062","qty":1},{"sku":"9289","qty":1},{"sku":"11286","qty":1},{"sku":"12038","qty":1},{"sku":"12253","qty":1},{"sku":"14000","qty":1},{"sku":"15522","qty":1},{"sku":"16701","qty":1},{"sku":"16725","qty":1},{"sku":"18104","qty":1},{"sku":"18372","qty":1},{"sku":"25192","qty":1},{"sku":"25193","qty":1},{"sku":"25194","qty":1},{"sku":"25195","qty":1},{"sku":"19034","qty":1},{"sku":"19038","qty":1},{"sku":"19060","qty":1},{"sku":"25542","qty":1},{"sku":"19243","qty":1},{"sku":"19354","qty":1},{"sku":"19361","qty":1},{"sku":"19367","qty":1},{"sku":"19496","qty":1}]
        }]
    };
    ...
    console.error("consultant", consultantData);

    //console.log("encrypted consultant data:");
    //console.log(encrypted);
    //var encoded = encrypted.replace(/\r\n/g, "\\r\\n");
    //encoded = encoded.replace(/\n/g, "\\n");
    //console.log("encoded encrypted consultant data:")
    console.log('"' + encrypted + '"');
